...
@section('content')
    <div class="row">
        <div class="col-md-8">
            <h4 class="mb-3">Formulir Tambah Lokasi</h4>
            ...
            <form action="{{ route('admin.locations.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('map_link') is-invalid @enderror" id="map_link" name="map_link" rows="3" placeholder="Paste link src dari iframe Google Maps di sini (https://www.google.com/maps/embed?...)">{{ old('map_link') }}</textarea>
