        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('valid_date') is-invalid @enderror" id="valid_date" name="valid_date" value="{{ old('valid_date') }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateStokBehavior() {
        ...
        if (isBundleOnly) {
            // Bundle Only: Stock is irrelevant (managed at bundle level)
            stokInput.readOnly = true;
            stokInput.classList.add('bg-light');
            stokInput.value = 999999;
            if (stokHelper) {
